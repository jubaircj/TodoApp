...
<body>
	...
	<div class="container col-md-8 col-md-offset-3" style="overflow: auto;" >
		...
		<p><i>*enter username & password to view users</i></p>
	...
	<div>
			<img alt="ToDoListImage" src="<%=request.getContextPath() + "/images/user-login.jpg"%>" style="width: 500px; height: 400px; margin-left: 600px; margin-top: -300px; ">
	</div>
